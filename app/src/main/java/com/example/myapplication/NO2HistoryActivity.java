...
public class NO2HistoryActivity extends AppCompatActivity implements OnMapReadyCallback , GoogleMap.OnMarkerClickListener{
...
//
                ...
                RequestQueue queue = Volley.newRequestQueue(NO2HistoryActivity.this);
...
//               chartUpdate(num);
    ...
    private void threadStart() {
        NO2HistoryActivity.MyThread thread = new NO2HistoryActivity.MyThread();
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(SEOUL));
    ...
    public boolean onMarkerClick(Marker marker) {
        ...
        for (int i = 0; i < boardInfos.size(); i++) {
            heart.add(new Entry(i, boardInfos.get(i).getRawno2()));
        }

        LineDataSet lineDataSet = new LineDataSet(heart, "NO2");
