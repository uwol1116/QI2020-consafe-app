...
public class O3HistoryActivity extends AppCompatActivity implements OnMapReadyCallback , GoogleMap.OnMarkerClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Toast.makeText(this, "O3", Toast.LENGTH_SHORT).show();
...
//
                ...
                RequestQueue queue = Volley.newRequestQueue(O3HistoryActivity.this);
...
//               chartUpdate(num);
    ...
    private void threadStart() {
        O3HistoryActivity.MyThread thread = new O3HistoryActivity.MyThread();
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(SEOUL));
    ...
    public boolean onMarkerClick(Marker marker) {
        ...
        for (int i = 0; i < boardInfos.size(); i++) {
            ...
            heart.add(new Entry(i, boardInfos.get(i).getRawo3()));

        }
        LineDataSet lineDataSet = new LineDataSet(heart, "O3");
