...
public class PM25HistoryActivity extends AppCompatActivity implements OnMapReadyCallback , GoogleMap.OnMarkerClickListener{
...
//
                ...
                RequestQueue queue = Volley.newRequestQueue(PM25HistoryActivity.this);
...
//               chartUpdate(num);
    ...
    private void threadStart() {
        PM25HistoryActivity.MyThread thread = new PM25HistoryActivity.MyThread();
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(SEOUL));
    ...
    public boolean onMarkerClick(Marker marker) {
        ...
        for (int i = 0; i < boardInfos.size(); i++) {
            if(boardInfos.get(1).getLongtitude() == boardInfos.get(i).getLongtitude()) {


                heart.add(new Entry(i, boardInfos.get(i).getRawpm()));
            }
        }
        LineDataSet lineDataSet = new LineDataSet(heart, "PM25");
