...
public class SO2HistoryActivity extends AppCompatActivity implements OnMapReadyCallback , GoogleMap.OnMarkerClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.content_so2_history);

        SupportMapFragment mapFragment = (SupportMapFragment) getSupportFragmentManager()
                .findFragmentById(R.id.map);
        mapFragment.getMapAsync(this);
        Toast.makeText(this, "SO2", Toast.LENGTH_SHORT).show();
...
//
                ...
                RequestQueue queue = Volley.newRequestQueue(SO2HistoryActivity.this);
...
//               chartUpdate(num);
    ...
    private void threadStart() {
        SO2HistoryActivity.MyThread thread = new SO2HistoryActivity.MyThread();
...
//        mMap.moveCamera(CameraUpdateFactory.newLatLng(SEOUL));
    ...
    public boolean onMarkerClick(Marker marker) {
        ...
        for (int i = 0; i < boardInfos.size(); i++) {
            ...
            heart.add(new Entry(i, boardInfos.get(i).getRawso2()));

        }
        LineDataSet lineDataSet = new LineDataSet(heart, "SO2");
